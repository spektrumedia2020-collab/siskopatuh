...
export function AdminDashboard() {
  ...
  return (
    <div className="flex min-w-0 w-full flex-col text-slate-200">

      {/* Global SOS Alert */}
      {sosAlerts.length > 0 && (
        <div className="sticky top-4 z-50 mb-6 flex flex-col gap-4 rounded-xl border-b border-red-900 bg-red-600/90 p-4 shadow-[0_0_20px_rgba(220,38,38,0.5)] backdrop-blur animate-pulse sm:flex-row sm:items-center sm:justify-between">
          <div className="flex min-w-0 items-start gap-3 sm:items-center sm:gap-4">
            <ShieldAlert className="mt-0.5 h-7 w-7 shrink-0 text-white sm:mt-0 sm:h-8 sm:w-8" />
            <div>
              <h2 className="text-base font-black uppercase tracking-wider text-white sm:text-lg">DARURAT: {sosAlerts.length} Sinyal SOS Jemaah Aktif di Lapangan!</h2>
              <p className="text-xs text-red-100 sm:text-sm">Harap segera koordinasi dengan Konsulat Jenderal RI atau pihak penerbangan terkait indikasi penelantaran.</p>
            </div>
          </div>
      ...
      {activeTab === 'kuota' && (
        <div className="flex flex-col gap-4 flex-grow">
          ...
          <div className="flex flex-col gap-4 mb-8 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex min-w-0 w-full items-center gap-3 rounded-lg border border-slate-700 bg-slate-900 p-3 lg:w-auto">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-1 flex min-w-0 flex-col items-stretch gap-2 sm:flex-row sm:items-center">
                  <input 
                    type="file" 
                    accept=".pdf"
                    className="min-w-0 max-w-full text-xs text-slate-400 file:mr-2 file:rounded-md file:border-0 file:bg-slate-800 file:px-2 file:py-1 file:text-xs file:font-semibold file:text-slate-300 hover:file:bg-slate-700"
                  ...
                  <Button 
                    ...
                    size="sm"
                    className="h-7 shrink-0 text-xs bg-emerald-600 hover:bg-emerald-500"
                  >
